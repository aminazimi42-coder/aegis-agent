"""T171 — hermesdev notary submit and staple, no notarized lie.
...
Apple in CI.  Does not start uvicorn.
"""
...
class TestT171NotarySubmitGuard(unittest.TestCase):
    """T171 — hermesdev notary submit and staple, no notarized lie."""
    ...
    # ------------------------------------------------------------------ #
    # 2) NOTARY_SKIPPED without profile
    # ------------------------------------------------------------------ #
    ...
    # ------------------------------------------------------------------ #
    # 3) NOTARIZED only after stapler validate
    # ------------------------------------------------------------------ #
    ...
    # ------------------------------------------------------------------ #
    # 4) No Apple ID or password flags
    # ------------------------------------------------------------------ #
